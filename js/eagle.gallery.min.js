...
this;if(1==a.options.showMediumImg)a.$elem.on("click",".rembo-medium-wrap",function(b){b.preventDefault();a.createGallery()});else d(this).parent().index(),a.$elem.find(".owl-item.active").index(),a.$elem.on("click",".owl-carousel."+a.miniOptions.theme+" .owl-item img",function(b){b.preventDefault();0==a.global.isNoDrag&&(a.$elem.find(".owl-item").removeClass("active"),d(this).parent().addClass("active"),a.createGallery())})},createGallery:function(){var a="",b=this.$elem.find("."+this.miniOptions.theme);
!1!==this.options.autoPlayMediumImg&&this.stopMedium();this.numberOfimages=b.find(".owl-item").length;this.currentImage=b.find(" .owl-item.active").index()+1;b.find(".owl-item").each(function(){var b=d(this),h=b.find("img").data("big-img");a=(b=b.find("img").data("title"))?a+'<div class="rembo-item" data-scale="1"><img src="'+h+'"><div class="title"><span>'+b+"</span></div></div>":a+'<div class="rembo-item" data-scale="1"><img src="'+h+'"></div>'});this.$elem.append('<div class="rembo-open-gallery"><div class="top-controls"><div class="ea-progress"><div class="ea-current">'+
this.currentImage+'</div><div>/</div><div class="ea-all">'+this.numberOfimages+'</div></div><div class="rembo-close"><span></span></div></div><div class="rembo-prev"><span></span></div><div class="view-big-img"><div class="owl-carousel">'+a+'</div></div><div class="rembo-next"><span></span></div><div class="bottom-controls"><div class="rembo-scale"><div class="ea-zoom ea-minus"><span></span></div><div class="ea-magnifier"></div><div class="ea-zoom ea-plus"><span></span></div></div></div></div>');
this.$gall=this.$elem.find(".rembo-open-gallery");this.options.bottomControlLine&&this.$gall.addClass("rembo-bottom-line");"transform"==this.options.openGalleryStyle&&(this.$gall.addClass("transform"),this.$gall.find(".top-controls, .bottom-controls, .view-big-img, .rembo-prev, .rembo-next").addClass("ea-hide"));this.$gall.addClass(this.options.theme);1==this.currentImage?this.$gall.find(".rembo-prev").addClass("disabled"):this.currentImage==b.find(".owl-item").length&&this.$gall.find(".rembo-next").addClass("disabled");
1==this.numberOfimages&&this.$gall.find(".rembo-next").addClass("disabled");this.global.open=this.$gall;this.showGallery()},showGallery:function(){var a=this,b=d("body").width(),c=d("body").outerWidth();b!=c&&(d("body").css({"padding-right":0}),a.bodyRightPadding=c-d("body").width(),a.bodyRightPadding=c-b-a.bodyRightPadding);d("body").css({overflow:"hidden"});b=d("body").outerWidth()-c;void 0!=a.bodyRightPadding?d("body").css({"padding-right":b+a.bodyRightPadding}):d("body").css({"padding-right":b});
...
a.options.openGallerySpeed+400),setTimeout(function(){function b(){c+=1;n.completeImg(a.$gall.find(".owl-item.active img").get(0))?a.$gall.find(".view-big-img").removeClass("ea-hide"):100>=c?k.setTimeout(b,100):a.$gall.find(".view-big-img").removeClass("ea-hide")}var c=0;b()},a.options.openGallerySpeed+800),setTimeout(function(){a.$elem.find(".transform").length&&a.$gall.find(".rembo-prev, .rembo-next").removeClass("ea-hide")},a.options.openGallerySpeed+1300),setTimeout(function(){a.$elem.find(".transform").length&&
...
galleryEvents:function(){var a=this;a.$gall.on("click",".rembo-prev",function(){a.owlGallery.prev()});a.$gall.on("click",".rembo-next",function(){a.owlGallery.next()});a.$gall.on("click",".view-big-img",function(){a.hideControls()});a.$gall.on("click",".rembo-close",function(){a.close()})},mouseDown:function(){this.$gall.find(".rembo-item").on("mousedown",function(){d(this).addClass("mouse-down")}).on("mouseup",function(){d(this).removeClass("mouse-down")})},gestures:function(){function a(a){var b=
...
".owl-item",f),e.$gall.on(e.ev_types.endZoom,".owl-item",g)):"off"===a&&(e.$gall.off(e.ev_types.moveZoom,".owl-item",f),e.$gall.off(e.ev_types.endZoom,".owl-item",g))}function f(b){b=b.originalEvent||b||k.event;var h=d(this).find(".rembo-item");l<e.options.maxZoom?(l=oldScale*c(q,a(b)),l>e.options.maxZoom&&(l=e.options.maxZoom),e.newPos(h,l),e.updateImg(h,l,e.global.newX,e.global.newY),e.direction(h,l)):(oldScale=e.options.maxZoom,l=oldScale*c(q,a(b)),q=a(b))}function g(a){var b=d(this).find(".rembo-item");
...
".rembo-scale .ea-plus",function(){var a=e.$gall.find(".owl-item.active .rembo-item");l=a.data("scale");0!=l%1&&(l=parseInt(l,10));l<e.options.maxZoom&&(1==l&&e.hideTitle(a.find(".title")),clearTimeout(k.remTran),a.css(n.addCssSpeed(200)),l++,e.updateImg(a,l,e.global.newX,e.global.newY),k.remTran=setTimeout(function(){a.css(n.removeTransition());e.direction(a,l)},200),a.data("scale",l).attr("data-scale",l))});e.$gall.on("click",".rembo-scale .ea-minus",function(){var a=e.$gall.find(".owl-item.active .rembo-item");
l=a.data("scale");0!=l%1?l=parseInt(l,10):1<l&&l--;1==l&&e.showTitle(a.find(".title"));e.newPos(a,l);clearTimeout(k.remTran);a.css(n.addCssSpeed(200));e.updateImg(a,l,e.global.newX,e.global.newY);k.remTran=setTimeout(function(){a.css(n.removeTransition());e.direction(a,l)},200);a.data("scale",l).attr("data-scale",l)});e.$gall.on(e.ev_types.startZoom,".owl-item",function(c){c=c.originalEvent||c||k.event;var g=d(this).find(".rembo-item");if(0!=e.global.isDrag)return!1;2===c.touches.length&&(c.preventDefault(),
...
2];a.prevArr.shift(0);if(a.prevItem!==a.currentItem&&(a.checkPagination(),a.checkNavigation(),a.eachMoveUpdate(),!1!==a.options.autoPlay&&a.checkAp(),a.options.galleryslider)){var b=a.$elem.find(".owl-item.active").index()+1;a.$elem.closest(".rembo-open-gallery").find(".ea-current").html(b);1==b?(a.$elem.closest(".rembo-open-gallery").find(".rembo-prev").addClass("disabled"),a.$elem.closest(".rembo-open-gallery").find(".rembo-next").removeClass("disabled")):b==a.$elem.find(".owl-item").length?(a.$elem.closest(".rembo-open-gallery").find(".rembo-next").addClass("disabled"),
a.$elem.closest(".rembo-open-gallery").find(".rembo-prev").removeClass("disabled")):a.$elem.closest(".rembo-open-gallery").find(".rembo-next, .rembo-prev").removeClass("disabled");setTimeout(function(){a.$owlItems.find(".rembo-item").removeAttr("style");f.global.open.find(".top-controls").hasClass("ea-hide")||a.$owlItems.find(".title").removeClass("hideTitle").removeClass("hideTitleMobile");f.global.leftDirection=!0;f.global.rightDirection=!0;f.global.topBottomDirection=!1;f.global.newX=0;f.global.newY=
0;a.$owlItems.find(".rembo-item").data("scale",1)},a.options.slideSpeed)}"function"===typeof a.options.afterMove&&a.prevItem!==a.currentItem&&a.options.afterMove.apply(this,[a.$elem])},stop:function(){this.apStatus="stop";k.clearInterval(this.autoPlayInterval)},checkAp:function(){"stop"!==this.apStatus&&this.play()},play:function(){var a=this;a.apStatus="play";if(!1===a.options.autoPlay)return!1;k.clearInterval(a.autoPlayInterval);a.autoPlayInterval=k.setInterval(function(){a.next(!0)},a.options.autoPlay)},
...
a.touches){if(void 0!==a.pageX)return{x:a.pageX,y:a.pageY};if(void 0===a.pageX)return{x:a.clientX,y:a.clientY}}}function b(a){"on"===a?(d(p).on(g.ev_types.move,h),d(p).on(g.ev_types.end,m)):"off"===a&&(d(p).off(g.ev_types.move),d(p).off(g.ev_types.end))}function c(b){var d=e.owlActive.find(".rembo-item"),c=e.owlActive.find("img"),g=e.owlActive.find(".rembo-item").data("scale");e.newX=a(b).x;e.newY=a(b).y;c.offset().left>e.owlActive.offset().left&&e.newX>e.oldX||c.offset().left+c.width()*g<e.owlActive.offset().left+
...
a.originalEvent||a||k.event;var c;c=e.owlActive.find(".rembo-item").data("scale");if(0<g.newRelativeX&&0==f.global.leftDirection){var h=e.owlActive.find("img"),m=e.owlActive.find(".rembo-item");a=(h.offset().left-e.owlActive.offset().left)/c;0<=a&&(f.global.leftDirection=!0,f.global.newX-=a);if(1==f.global.topBottomDirection){var p=(h.offset().top-e.owlActive.offset().top)/c,h=(h.offset().top+h.height()*c-(e.owlActive.offset().top+e.owlActive.height()))/c;0<p&&(f.global.newY-=p);0>h&&(f.global.newY-=
h)}else f.global.newY=0;if(0<=a||1==f.global.topBottomDirection)m.css(n.addCssSpeed(100)),f.updateImg(m,c,f.global.newX,f.global.newY),setTimeout(function(){m.css(n.removeTransition())},100);b("off");f.global.isDrag=0;return!1}if(0>g.newRelativeX&&0==f.global.rightDirection){h=e.owlActive.find("img");m=e.owlActive.find(".rembo-item");a=(h.offset().left+h.width()*c-(e.owlActive.offset().left+e.owlActive.width()))/c;0>=a&&(f.global.rightDirection=!0,f.global.newX-=a);1==f.global.topBottomDirection?
(p=(h.offset().top-e.owlActive.offset().top)/c,h=(h.offset().top+h.height()*c-(e.owlActive.offset().top+e.owlActive.height()))/c,0<p&&(f.global.newY-=p),0>h&&(f.global.newY-=h)):f.global.newY=0;if(0>=a||1==f.global.topBottomDirection)m.css(n.addCssSpeed(100)),f.updateImg(m,c,f.global.newX,f.global.newY),setTimeout(function(){m.css(n.removeTransition())},100);b("off");f.global.isDrag=0;return!1}1==f.global.topBottomDirection&&(h=e.owlActive.find("img"),m=e.owlActive.find(".rembo-item"),p=(h.offset().top-
